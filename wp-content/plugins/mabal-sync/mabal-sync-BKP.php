...
class MabalSync
{
    ...
    function sendShippingInfo( $order_id ) {
        ...
        $url = "https://mabalgarve.dyndns.org:5342/phc/rest/". $this->HostId ."/customer/document/?format=xml";
        ...
        wp_mail("mohsibtain@gmail.com", "MABAL shipping output V2", json_encode($objResponse) );
